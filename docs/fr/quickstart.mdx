...
description: "Installez le SDK TypeScript, ingérez une ressource vidéo ou audio, attendez l'indexation et lancez votre première recherche cadrée sur l'API sf-voice media."
icon: "rocket"
---
