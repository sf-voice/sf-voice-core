...
description: "Référence du SDK TypeScript @sf-voice/media : créez un client, ingérez des ressources, interrogez les tâches et recherchez vidéo, audio et transcriptions."
icon: "code"
---
...
| `apiKey` | Oui | Votre clé `sk_live_...`, envoyée comme en-tête `Authorization: Bearer`. |
