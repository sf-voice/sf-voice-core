...
description: "Référence du SDK TypeScript @sf-voice/media : créez un client, ingérez des ressources, interrogez les tâches d'indexation et recherchez dans la vidéo, l'audio et les transcriptions."
icon: "code"
---
