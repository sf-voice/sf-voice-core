---
title: "SDK TypeScript pour sf-voice media search"
description: "Le SDK @sf-voice/media pour ingérer des enregistrements, interroger les tâches d'indexation et rechercher dans audio, vidéo et transcriptions depuis Node.js."
icon: "code"
---
