---
title: "Comment fonctionne sf-voice media"
description: "Découvrez le modèle d'actifs, de classes d'actifs et de surfaces d'indexation utilisé par sf-voice pour indexer audio, vidéo et transcriptions horodatés."
icon: "workflow"
---
