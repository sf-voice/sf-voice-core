---
title: "Avvio rapido: indicizza e cerca la prima registrazione"
description: "Installa l'SDK TypeScript, ingerisci una registrazione, esegui il polling del job di indicizzazione e lancia la tua prima ricerca con sf-voice media."
icon: "rocket"
---
