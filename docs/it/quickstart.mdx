---
title: "Avvio rapido"
description: "Installa l'SDK TypeScript, ingerisci un asset video o audio, attendi l'indicizzazione ed esegui la tua prima ricerca con ambito su sf-voice media."
icon: "rocket"
---
