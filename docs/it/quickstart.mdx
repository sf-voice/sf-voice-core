---
title: "Avvio rapido: indicizza una registrazione"
description: "Installa l'SDK TypeScript, ingerisci una registrazione di chiamata, esegui il polling del job di indicizzazione e lancia la tua prima ricerca con ambito."
icon: "rocket"
---
