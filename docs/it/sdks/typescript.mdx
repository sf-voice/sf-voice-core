...
description: "Installa @sf-voice/media per ingerire registrazioni, eseguire il polling dei job di indicizzazione e cercare tra audio, video e trascrizioni da TypeScript."
icon: "code"
---
