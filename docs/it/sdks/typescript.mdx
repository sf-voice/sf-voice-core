...
description: "Riferimento per l'SDK TypeScript @sf-voice/media: crea un client, ingerisci asset, esegui il polling dei task e cerca tra video, audio e trascrizioni."
icon: "code"
---
...
| `apiKey` | Sì | La tua chiave `sk_live_...`, inviata come header `Authorization: Bearer`. |
