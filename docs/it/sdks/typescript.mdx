...
description: "Riferimento per l'SDK TypeScript @sf-voice/media: crea un client, ingerisci asset, esegui il polling dei task di indicizzazione e cerca tra video, audio e trascrizioni."
icon: "code"
---
