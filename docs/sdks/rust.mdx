---
title: "Rust SDK"
description: "Async Rust SDK built on reqwest and tokio to ingest recordings, poll indexing jobs, and search audio, video, and transcripts with a builder API."
---
