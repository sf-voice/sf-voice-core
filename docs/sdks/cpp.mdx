---
title: "C++ SDK"
description: "Single-header C++17 SDK using std::future, CPR, and nlohmann/json to ingest recordings and search audio, video, and transcripts via CMake FetchContent."
---
