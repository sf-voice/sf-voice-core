---
title: "C++ SDK for sf-voice media search"
description: "The single-header C++ SDK for ingesting recordings, polling tasks, and searching media — std::future-based async API targeting C++17 with CPR and nlohmann."
---
