---
title: "TypeScript"
description: "@sf-voice/media TypeScript SDK reference: create a client, ingest assets, poll indexing tasks, and search video, audio, and transcripts."
---
...
| `apiKey` | `string` | — | Required. Your `sk_live_...` key, sent as `Authorization: Bearer`. |
