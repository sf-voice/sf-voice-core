---
title: "TypeScript SDK for sf-voice media search"
description: "The @sf-voice/media TypeScript SDK for ingesting recordings, polling indexing tasks, and searching audio, video, and transcripts in Node.js, Bun, and Deno."
---
