---
title: "Kotlin SDK"
description: "Coroutine-native Kotlin SDK built on Ktor to ingest call recordings and search audio, video, and transcripts from JVM or Android applications."
---
