---
title: "Elixir SDK for sf-voice media search"
description: "The :sf_voice Elixir SDK for ingesting recordings, polling tasks, and searching media — Req-based client returning {:ok, result} or {:error, reason} tuples."
---
