---
title: "SDKs for TypeScript, Python, Go, Rust, and more"
description: "Official sf-voice media SDKs for TypeScript, Python, Elixir, Go, Rust, Java, Kotlin, and C++ — covering ingest, polling, asset management, and search."
---
