---
title: "Quickstart: ingest a recording and run a search"
description: "Install the TypeScript SDK, ingest a call recording, poll the indexing job, and run your first scoped search against the sf-voice media API."
---
