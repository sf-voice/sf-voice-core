---
title: "Quickstart: ingest and search your first recording"
description: "Install the TypeScript SDK, ingest a recording, poll the indexing task, and run your first scoped search — from an API key to results in minutes."
---
