---
title: "Guía rápida: indexa una grabación y busca"
description: "Instala el SDK de TypeScript, ingiere una grabación de llamada, sondea el trabajo de indexación y ejecuta tu primera búsqueda acotada en sf-voice."
icon: "rocket"
---
