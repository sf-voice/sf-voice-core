---
title: "Guía rápida"
description: "Instala el SDK de TypeScript, ingiere un recurso de vídeo o audio, espera a que se indexe y ejecuta tu primera búsqueda acotada contra la API de sf-voice media."
icon: "rocket"
---
