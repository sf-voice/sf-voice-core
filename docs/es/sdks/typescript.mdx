...
description: "Instala @sf-voice/media para ingerir grabaciones, sondear trabajos de indexación y buscar en audio, vídeo y transcripciones desde Node.js, Bun o Deno."
icon: "code"
---
