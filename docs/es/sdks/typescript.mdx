...
description: "Referencia del SDK TypeScript @sf-voice/media: crea un cliente, ingiere recursos, sondea tareas de indexación y busca en vídeo, audio y transcripciones."
icon: "code"
---
...
| `apiKey` | Sí | Tu clave `sk_live_...`, enviada como cabecera `Authorization: Bearer`. |
