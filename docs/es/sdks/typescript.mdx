---
title: "SDK de TypeScript para sf-voice media search"
description: "El SDK @sf-voice/media para ingerir grabaciones, sondear tareas de indexación y buscar en audio, vídeo y transcripciones desde Node.js, Bun y Deno."
icon: "code"
---
