---
title: "How sf-voice media indexing and search works"
description: "Learn the asset, asset class, and indexing surface model that sf-voice uses to index audio, video, and transcripts and return timestamped results."
---
