---
title: "Core concepts: assets, classes, and search scope"
description: "How sf-voice models recordings as assets with IDs and classes, indexes audio, video, and transcripts, and returns timestamped, scoped search results."
---
